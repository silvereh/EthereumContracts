...
const getTestCasesByFunction = ( signature, params ) => {
...
const getTestCases = ( varType, varName, index ) => {
	switch ( varType ) {
		case 'address':
...
const addressCases = ( varName, index ) => {
	return [
		{
		...
		{
			test_description : 'Input string instead of `' + varName + '` should throw "' + THROW.INVALID_ADDRESS_OR_ENS + '"',
			test_variable_index : index,
...
const addressArrayCases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
...
const bytes4Cases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
...
const bytes32Cases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
			test_description    : 'Input address instead of `' + varName + '` should throw "' + THROW.INCORRECT_DATA_LENGTH + '"',
...
const bytesCases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
...
const booleanCases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
...
const stringCases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
			test_description    : 'Input address instead of `' + varName + '` should not throw',
...
const uint256Cases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
...
const uint256ArrayCases = ( varName, index ) => {
	return [
		{
			test_variable_index : index,
...
const generateFailTest = async ( testedFunc, params, extra_var = null ) => {
	...
	switch ( numArgs ) {
		case 0:
			await generateFailTest0( testedFunc, params, extra_var )
			break;
		case 1:
			await generateFailTest1( testedFunc, params, extra_var )
			break;
		case 2:
			await generateFailTest2( testedFunc, params, extra_var )
			break;
		case 3:
			await generateFailTest3( testedFunc, params, extra_var )
			break;
		case 4:
			await generateFailTest4( testedFunc, params, extra_var )
			break;
		case 5:
			await generateFailTest5( testedFunc, params, extra_var )
			break;
		case 6:
			await generateFailTest6( testedFunc, params, extra_var )
			break;
		case 7:
			await generateFailTest7( testedFunc, params, extra_var )
			break;
		case 8:
			await generateFailTest8( testedFunc, params, extra_var )
			break;
		case 9:
			await generateFailTest9( testedFunc, params, extra_var )
			break;
		case 10:
			await generateFailTest10( testedFunc, params, extra_var )
			break;
		default:
			return;
	}
...
const generateFailTest0 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest1 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest2 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest3 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest4 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest5 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest6 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest7 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest8 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest9 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateFailTest10 = async ( testedFunc, params, extra_var = null ) => {
	if ( params.err ) {
		if ( extra_var ) {
...
const generateTestCase = async ( contract, testCase, defaultArgs, prop, val ) => {
