...
const ARTIFACT = require( '../../artifacts/contracts/mocks/tokens/Mock_ERC721MapBurnable.sol/Mock_ERC721MapBurnable.json' )
...
const TEST = {
	NAME : 'ERC721MapBurnable',
}

// For contract data
const CONTRACT = {
	NAME : 'Mock_ERC721MapBurnable',
	PARAMS : {
		CONSTRUCT : {},
		INIT_SUPPLY : 0,
		TX_MAX      : 1080,
