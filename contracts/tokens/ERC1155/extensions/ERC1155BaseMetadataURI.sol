...
*/
abstract contract ERC1155BaseMetadataURI is ERC1155Base, IERC1155MetadataURI {
	...
	*/
	...
	function supportsInterface( bytes4 interfaceId_ ) external view virtual override(ERC1155Base, IERC165) returns ( bool ) {
		return 
